<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
  <div class="sm:mx-auto sm:w-full sm:max-w-sm">
    ...
    <h2 class="mt-10 text-center text-2xl/9 font-bold tracking-tight text-gray-900">Create your master key</h2>
  </div>
    ...
    <form class="space-y-6" action="#" method="POST">
      <div>
        <div class="flex items-center justify-between">
          <label for="password" class="block text-sm/6 font-medium text-gray-900">Master Password</label>
        </div>
        <div class="text-[.7rem]">
          No username is needed. You are the only one who will use this :)
        </div>
        <div class="mt-2">
